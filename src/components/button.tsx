...
const DEFAULT_BUTTON_CLASSES =
  "text-sm rounded focus:outline-none focus:ring ring-btn-focus disabled:cursor-not-allowed";
...
export function ButtonLink({ children, className, variant, ...rest }: ButtonLinkProps) {
  return (
    <Link
      className={classnames(
